...
input_folder = "/mnt/c/Users/User/Documents/Indra/geo/CDR/parsing/Video_chat/Input"
output_path = "/mnt/c/Users/User/Documents/Indra/geo/CDR/parsing/Video_chat/Output"
...
file_list = [f for f in os.listdir(input_folder) if f.endswith(".xlsx") and "Data_VideoChat" in f and "clean" not in f]
...
# Add end_latitude and end_longitude using last_val
...
def export_country(country_group):
    ...
    output_file = os.path.join(output_path, f"Data_VideoChat_{country_name}_clean.xlsx")
