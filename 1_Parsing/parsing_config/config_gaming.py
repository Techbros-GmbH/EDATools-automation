...
def egaming_first_val(x: pd.Series) -> Any:
...
GAMING_AGG_RULES = {
    "Date Time": egaming_first_val,
    "Test Name": egaming_first_val,
    "TWAMP Address" : modus,
    "TWAMP Start Time" : modus,
    "TWAMP End Time": modus,
    "Latitude": egaming_first_val,
    "Longitude": egaming_first_val,
    "Country": egaming_first_val,
    "Type Mobility": egaming_first_val,
    "DeviceDescription": egaming_first_val,
    "IMEI": egaming_first_val,
    "IMSI": egaming_first_val,
    "MCC": egaming_first_val,
    "MNC": egaming_first_val,
    "SIM Operator": egaming_first_val,
