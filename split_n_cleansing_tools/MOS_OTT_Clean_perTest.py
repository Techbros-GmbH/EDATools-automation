...
# === Load Excel ===
input_folder = Path("/mnt/c/Users/User/Documents/Indra/geo/CDR/parsing/split/MOS_OTT/Input")
...
def reorder_columns_strict(df, group_key="MOSOTT"):
...
merged_df = reorder_columns_strict(merged_df, group_key="MOSOTT")
...
output_dir = Path("/mnt/c/Users/User/Documents/Indra/geo/CDR/parsing/split/MOS_OTT/Output2")
...
output_file_name = f"{date_str}_{country}_BM_CDRMOS_OTT.xlsx"
